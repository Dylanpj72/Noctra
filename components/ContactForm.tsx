    ...
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-4 pt-2">
        <button
          ...
          className="group relative overflow-hidden w-full py-4 rounded-full text-[14px] font-semibold text-black bg-white transition-all duration-300 hover:shadow-[0_0_0_4px_rgba(255,255,255,0.1),0_12px_40px_rgba(255,255,255,0.15)] hover:scale-[1.01] disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white active:scale-[0.98]"
        >
          {status === 'sending' ? (

...
export function Process() {
  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" className="absolute right-0 inset-y-0 w-[60%] pointer-events-none translate-x-[30%]">
        <Image
      ...
      {/* Left fade only — fades image into black towards the cards */}
